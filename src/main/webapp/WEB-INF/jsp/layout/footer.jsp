        ...
        <%-- Determine if we are on an auth page --%>
            ...
            <c:if test="${not isAuthPage}">
                ...
                <div id="player-bar"
                    ...
                    <div class="d-flex align-items-center" style="width: 30%; min-width: 180px;">
                        ...
                        <div class="d-flex flex-column overflow-hidden me-3">
                            ...
                            <div id="player-artist" class="small text-secondary text-truncate"
                                style="font-size: 0.75rem;">Artis</div>
                        </div>
                ...
                <div id="player-expanded"
                    class="d-none flex-column align-items-center justify-content-center text-white"
                    ...
                    <div class="d-flex justify-content-between align-items-center w-100 px-4 py-3"
                        ...
                        <button class="btn btn-link text-white p-0 fs-4"><i class="bi bi-three-dots"></i></button>
                    </div>
